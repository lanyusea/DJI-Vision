...
public class MyoGlassService extends Service {
    ...
    public void attachToNewMyo() {
        ...
        mHub.attachByMacAddress("EE:F9:F6:7E:18:19");
    }
    ...
    private class MyoListener extends AbstractDeviceListener {
        ...
        public void onOrientationData (Myo myo, long timestamp, Quaternion rotation)
        {
            ...
            double z=q.z();
            double w=q.w();
            double yaw=Math.atan2(2*w*z+2*x*y,1-2*y*y-2*z*z);
            double pitch=Math.asin(2*w*y-2*z*x);
            double roll=Math.atan2(2*w*x+2*y*z,1-2*x*x-2*y*y);
            accelerometer = new Vector3(yaw,pitch,roll);
        }
        ...
        public void onAttach(Myo myo, long timestamp) {
            ...
            Log.e(TAG,myo.getMacAddress());
            MainActivity.isMYOReady=true;
        }
