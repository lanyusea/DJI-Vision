 ...
 */
public class MotionEventGenerator extends MainActivity{
    ...
    public static List<MotionEvent> getSwipeDownEvents() {
        ...
        return getSwipeEvents(600f, 0f, 600f, 0f);
    }
    ...
    public static List<MotionEvent> getSwipeLeftEvents() {
        return getSwipeEvents(680f, 100f, 680f, 100f);
    }
    ...
    public static List<MotionEvent> getTapEvents() {
        List<MotionEvent> events = null;//new ArrayList<MotionEvent>();
        if(!MainActivity.isFlying){
